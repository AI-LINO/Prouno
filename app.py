...
def calcular_mecha_simple(precio, rsi, bb_pct, cambio_24h):
    ...
    # Si ya subi mucho en 24h, menos mecha
    ...
    if not market_data:
        ...
        **Soluciones:**
        ...
        if not resultados_cg:
            ...
            #  SELECTOR  ANLISIS + AGREGAR AL LIVE 
            st.divider()
